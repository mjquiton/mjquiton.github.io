...
let bikeURL = 'https://mjquiton.github.io/assignments/mountain-spoke/data/data-ms.json';
...
bike.onload = function(){
   var bikeinfo = bike.response;
    ...
    var quickbike = bikeinfo.bikes[0].name;
    document.getElementById("qTune").innerHTML = quickbike;
    
    var quickprice = bikeinfo.bikes[0].name;
    document.getElementById("qPrice").innerHTML = quickprice;
    
    var quickdesc = bikeinfo.bikes[0].description;
